...
%
\section{Problem}
Consider the matrix A=\myvec{0 & 1 \\1 & 0 } over the field Q of rationals which of the following matrices are of the form $P^{t}AP$ for a suitable invertible matrix P over Q?
...
\begin{align}
    ...
    ad-bc\neq0
\end{align}
So  matrix \myvec{2 & 0\\0 & -2} is the right option
